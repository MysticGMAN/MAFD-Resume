      ...
      *
       01 ws-name-line.
         ...
         05 filler pic x(25) value '    M Y   N A M E   '.
      *               ----+----1----+----2----+
         05 filler pic x(29) value '     GRAYSON CLOSS      lab 7'.
      *               ----+----1----+----2----+----
         05 filler pic x(5) value spaces.
      ...
      *
         perform 300-process-records until ws-end-of-file.
      *
      *output total lines
      ...
      *
       100-print-headings.
      *
         write report-line from ws-name-line after advancing 1 line.
      *
         write report-line from ws-report-heading
           after advancing 1 line.
      *
         write report-line from ws-heading-line1 after advancing 2 lines
           .
      *
         write report-line from ws-heading-line2 after advancing 1 line.
      *
       200-read-input-file.
